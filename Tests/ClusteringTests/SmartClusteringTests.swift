...
class ClusteringTests: XCTestCase {
    ...
    func testGoogleSearchClustering() async throws {
        ...
        let textualItems = [
            TextualItem(uuid: UUIDs[0], url: "https://www.google.com/search?q=mozart", title: "mozart - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[1], url: "https://www.google.com/search?q=classical%20music%20mozart", title: "classical music mozart - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[2], url: "https://www.google.com/search?q=cat", title: "cat - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[3], url: "https://www.google.com/search?q=dog", title: "dog - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[4], url: "https://www.google.com/search?q=worm", title: "worm - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[5], url: "https://www.google.com/search?q=snake", title: "snake - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[6], url: "https://www.google.com/search?q=beethoven", title: "beethoven - Google Search", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[7], url: "https://www.google.com/search?q=musique%20classique", title: "musique classique - Google Search", type: TextualItemType.page)
        ]
    ...
    func testFullemptyPages() async throws {
        ...
        let textualItems = [
            TextualItem(uuid: UUIDs[0], url: "https://www.google.com/search?q=mozart", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[1], url: "https://www.google.com/search?q=classical%20music%20mozart", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[2], url: "https://www.google.com/search?q=cat", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[3], url: "https://www.google.com/search?q=dog", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[4], url: "https://www.google.com/search?q=worm", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[5], url: "https://www.google.com/search?q=snake", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[6], url: "https://www.google.com/search?q=beethoven", type: TextualItemType.page),
            TextualItem(uuid: UUIDs[7], url: "https://www.google.com/search?q=musique%20classique", type: TextualItemType.page)
        ]
        var clusteredPageIds: [[UUID]] = []
    ...
    func testMixPageNote() async throws {
        ...
        let textualItems = [
            TextualItem(uuid: pageUUIDs[0], url: "https://en.wikipedia.org/wiki/Roger_Federer", content: "Federer has played in an era where he dominated men's tennis together with Rafael Nadal and Novak Djokovic, who have been collectively referred to as the Big Three and are widely considered three of the greatest tennis players of all-time. A Wimbledon junior champion in 1998, Federer won his first Grand Slam singles title at Wimbledon in 2003 at age 21. In 2004, he won three out of the four major singles titles and the ATP Finals, a feat he repeated in 2006 and 2007. From 2005 to 2010, Federer made 18 out of 19 major singles finals. During this span, he won his fifth consecutive titles at both Wimbledon and the US Open. He completed the career Grand Slam at the 2009 French Open after three previous runner-ups to Nadal, his main rival up until 2010. At age 27, he also surpassed Pete Sampras's then-record of 14 Grand Slam men's singles titles at Wimbledon in 2009.", type: TextualItemType.page),
            TextualItem(uuid: pageUUIDs[1], url: "https://en.wikipedia.org/wiki/Rafael_Nadal", content: "From childhood through most of his professional career, Nadal was coached by his uncle Toni. He was one of the most successful teenagers in ATP Tour history, reaching No. 2 in the world and winning 16 titles before his 20th birthday, including his first French Open and six Masters events. Nadal became No. 1 for the first time in 2008 after his first major victory off clay against his rival, the longtime top-ranked Federer, in a historic Wimbledon final. He also won an Olympic gold medal in singles that year in Beijing. After defeating Djokovic in the 2010 US Open final, the 24-year-old Nadal became the youngest man in the Open Era to achieve the career Grand Slam, and also became the first man to win three majors on three different surfaces (hard, grass and clay) the same calendar year. With his Olympic gold medal, he is also one of only two male players to complete the career Golden Slam.", type: TextualItemType.page),
            TextualItem(uuid: pageUUIDs[2], url: "https://www.youtube.com", content: "All", type: TextualItemType.page),
            TextualItem(uuid: noteUUIDs[0], title: "Roger Federer", content: "Sa victoire à Roland-Garros en 2009 lui a permis d'accomplir le Grand Chelem en carrière sur quatre surfaces différentes. En s'adjugeant ensuite l'Open d'Australie en 2010, il devient le premier joueur de l'histoire à avoir conquis l'ensemble de ses titres du Grand Chelem sur un total de cinq surfaces, depuis le remplacement du Rebound Ace australien par une nouvelle surface : le Plexicushion. Federer a réalisé le Petit Chelem de tennis à trois reprises, en 2004, 2006 et 2007, ce qui constitue à égalité avec Novak Djokovic, le record masculin toutes périodes confondues. Il est ainsi l'unique athlète à avoir gagné trois des quatre tournois du Grand Chelem deux années successives. Il atteint à trois reprises, et dans la même saison, les finales des quatre tournois majeurs, en 2006, 2007 et 2009, un fait unique dans l'histoire de ce sport.", type: TextualItemType.note),
            TextualItem(uuid: noteUUIDs[1], title: "Rafael Nadal", content: "Il est considéré par tous les spécialistes comme le meilleur joueur sur terre battue de l'histoire du tennis, établissant en effet des records majeurs, et par la plupart d'entre eux comme l'un des meilleurs joueurs de simple de tous les temps, si ce n’est le meilleur. Il a remporté vingt tournois du Grand Chelem (un record qu'il détient avec Roger Federer et Novak Djokovic) et est le seul joueur à avoir remporté treize titres en simple dans un de ces quatre tournois majeurs : à Roland-Garros où il s'est imposé de 2005 à 2008, de 2010 à 2014, puis de 2017 à 2020. À l'issue de l'édition 2021, où il est détrôné en demi-finale par Novak Djokovic, il présente un bilan record de cent-cinq victoires pour trois défaites dans ce tournoi parisien, et ne compte aucune défaite en finale. Il a remporté également le tournoi de Wimbledon en 2008 et 2010, l'Open d'Australie 2009 et l'US Open 2010, 2013, 2017 et 2019. Il est ainsi le septième joueur de l'histoire du tennis à réaliser le « Grand Chelem en carrière » en simple. À ce titre, Rafael Nadal est le troisième joueur et le plus jeune à s'être imposé durant l'ère Open dans les quatre tournois majeurs sur quatre surfaces différentes, performance que seuls Roger Federer, Andre Agassi et Novak Djokovic ont accomplie.", type: TextualItemType.note)
        ]
        var clusteredPageIds: [[UUID]] = []
    ...
    func testRemoveTextualItem() async throws {
        ...
        for i in 0...2 {
            pageUUIDs.append(UUID())
            let myPage = TextualItem(uuid: pageUUIDs[i], url: "http://note.com", title: "My note", content: "This is my note", type: TextualItemType.page)
